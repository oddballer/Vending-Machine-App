...
1. The vending machine dispenses beverages, candy, chips, and gum. (Note: Vendables)
...
7. The purchase process flow is as follows:
    ...
    transaction and receive any remaining change.
        ...
        (using the smallest amount of coins possible).
          - Note to self: This can be accomplished with a while loop, while balance > 0, and if-else statements on the balance.
